"use strict";(self.webpackChunk_dev_app=self.webpackChunk_dev_app||[]).push([[22],{1828:(e,t,n)=>{n.d(t,{K2:()=>E,Yg:()=>Y,zO:()=>$,y_:()=>R,VT:()=>L,RY:()=>I});var s=n(2784),r=n(6647),o=n(7598),a=n(9385);const i=new r.GraphQLClient(`${location.pathname}graphql`,{headers:{}}),c=(0,a.eI)({url:`${{"https:":"wss:"}[location.protocol]||"ws:"}//${location.host}${location.pathname}subscriptions`});class l{client=i;subscriptions=c}const u=r.gql`
  query {
    files {
      name
    }
