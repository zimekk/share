"use strict";(self.webpackChunk_dev_app=self.webpackChunk_dev_app||[]).push([[22],{9082:(e,t,n)=>{n.d(t,{L:()=>a,V:()=>o});var s=n(6647),r=n(9385);const a=new s.GraphQLClient(`${location.pathname}graphql`,{headers:{}}),o=(0,r.eI)({url:`${{"https:":"wss:"}[location.protocol]||"ws:"}//${location.host}${location.pathname}subscriptions`})},310:(e,t,n)=>{n.d(t,{Yg:()=>q,zO:()=>h,y_:()=>M,VT:()=>A,RY:()=>E});var s=n(2784),r=n(6647),a=n(7598),o=n(9082);class c{client=o.L;subscriptions=o.V}const i=r.gql`
  query {
    files {
      name
    }
