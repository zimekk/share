"use strict";(self.webpackChunk_dev_app=self.webpackChunk_dev_app||[]).push([[22],{1828:(e,t,n)=>{n.d(t,{K2:()=>A,Yg:()=>F,zO:()=>w,y_:()=>T,VT:()=>k,RY:()=>L});var s=n(2784),r=n(6647),o=n(4489),a=n(9385);const c=new r.GraphQLClient(`${location.pathname}graphql`,{headers:{}}),i=(0,a.eI)({url:`${{"https:":"wss:"}[location.protocol]||"ws:"}//${location.host}${location.pathname}subscriptions`});class l{client=c;subscriptions=i}const u=r.gql`
  query {
    files {
      name
    }
