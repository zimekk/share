"use strict";(self.webpackChunk_dev_app=self.webpackChunk_dev_app||[]).push([[22],{4281:(e,t,n)=>{n.d(t,{IE:()=>M,K2:()=>T,Yg:()=>W,zO:()=>R,y_:()=>L,VT:()=>I,RY:()=>Y});var s=n(2784),r=n(6647),o=n(7598),a=n(9385);const i=new r.GraphQLClient(`${location.pathname}graphql`,{headers:{}}),c=(0,a.eI)({url:`${{"https:":"wss:"}[location.protocol]||"ws:"}//${location.host}${location.pathname}subscriptions`});class l{client=i;subscriptions=c}const u=r.gql`
  query {
    files {
      name
    }
...
`;class M extends l{getMovies(){return(0,o.D)(this.client.request(v))}}var q=n(7984);const y=r.gql`
