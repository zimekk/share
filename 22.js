"use strict";(self.webpackChunk_dev_app=self.webpackChunk_dev_app||[]).push([[22],{9082:(e,t,n)=>{n.d(t,{L:()=>o,V:()=>a});var s=n(6647),r=n(9385);const o=new s.GraphQLClient(`${location.pathname}graphql`,{headers:{}}),a=(0,r.eI)({url:`${{"https:":"wss:"}[location.protocol]||"ws:"}//${location.host}${location.pathname}subscriptions`})},1828:(e,t,n)=>{n.d(t,{K2:()=>D,Yg:()=>U,zO:()=>w,y_:()=>T,VT:()=>R,RY:()=>k});var s=n(2784),r=n(6647),o=n(7598),a=n(9082);class i{client=a.L;subscriptions=a.V}const c=r.gql`
  query {
    files {
      name
    }
