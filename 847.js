"use strict";(self.webpackChunk_dev_app=self.webpackChunk_dev_app||[]).push([[847],{1828:(e,t,n)=>{n.d(t,{K2:()=>M,Yg:()=>L,zO:()=>A,y_:()=>P,VT:()=>V,RY:()=>x});var l=n(2784),s=n(6647),a=n(7598),r=n(9385);const o=new s.GraphQLClient(`${location.pathname}graphql`,{headers:{}}),u=(0,r.eI)({url:`${{"https:":"wss:"}[location.protocol]||"ws:"}//${location.host}${location.pathname}subscriptions`});class c{client=o;subscriptions=u}const i=s.gql`
  query {
    files {
      name
    }
