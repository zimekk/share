"use strict";(self.webpackChunk_dev_app=self.webpackChunk_dev_app||[]).push([[847],{4281:(e,t,n)=>{n.d(t,{IE:()=>y,K2:()=>R,Yg:()=>L,zO:()=>I,y_:()=>V,VT:()=>T,RY:()=>G});var l=n(2784),s=n(6647),a=n(7598),r=n(9385);const o=new s.GraphQLClient(`${location.pathname}graphql`,{headers:{}}),c=(0,r.eI)({url:`${{"https:":"wss:"}[location.protocol]||"ws:"}//${location.host}${location.pathname}subscriptions`});class u{client=o;subscriptions=c}const i=s.gql`
  query {
    files {
      name
    }
...
`;class y extends u{getMovies(){return(0,a.D)(this.client.request(E))}}var h=n(7984);const v=s.gql`
