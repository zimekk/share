"use strict";(self.webpackChunk_dev_app=self.webpackChunk_dev_app||[]).push([[309],{6309:(e,s,t)=>{t.r(s),t.d(s,{default:()=>u});var n=t(2784),r=t(1828),a=t(9606);function o(){const[{messages:e},{sendMessage:s}]=(0,r.y_)(),[t,o]=(0,n.useState)(""),u=()=>{o(""),s({uuid:null,text:t})};return n.createElement("div",{className:a.Z.Messages},n.createElement("span",null,null),n.createElement("input",{value:t,onChange:e=>{const{value:s}=e.target;o(s)},onKeyDown:e=>"Enter"===e.key&&!e.shiftKey&&(e.preventDefault(),u())}),n.createElement("button",{onClick:u},"send"),e&&n.createElement("div",null,n.createElement("pre",null,e.map((({uuid:e,text:s})=>`[${e}] ${s}`)).join("\n"))))}function u(){return n.createElement(o,null)}},1828:(e,s,t)=>{t.d(s,{K2:()=>D,Yg:()=>Y,zO:()=>k,y_:()=>Q,VT:()=>C,RY:()=>_});var n=t(2784),r=t(6647),a=t(7598),o=t(9385);const u=new r.GraphQLClient(`${location.pathname}graphql`,{headers:{}}),l=(0,o.eI)({url:`${{"https:":"wss:"}[location.protocol]||"ws:"}//${location.host}${location.pathname}subscriptions`});class i{client=u;subscriptions=l}const c=r.gql`
  query {
    files {
      name
    }
